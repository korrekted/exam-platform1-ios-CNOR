...
final class GlobalDefinitions {
    ...
    static let apiKey = "jncYrDGnULOTVYhL"

    static let sdkDomainUrl = "https://analytics.korrekted.com"
    static let sdkApiKey = "ZTVmvdumy9Esqntv"

    static let applicationTag = "EXAM_CNOR"

    static let amplitudeApiKey = "b503251969f4b1d7901d2f7d1388d476"
    static let appsFlyerApiKey = "DCciCfYXjMQ8QnkdCg8qzk"

    static let appStoreUrl = "https://apps.apple.com/app/cnor-exam-test-prep/id1584529078"
    static let appleAppID = "1584529078"
